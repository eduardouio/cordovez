...
*/
   ...
   function getCountries(){
   	$.each(incotermsDb , function(key, value){
   		if($.inArray(value.pais, countries) === -1){
   			 ...
   			 $('#pais_origen').append('<option value="'+ value.pais + '">' + 
   			 																							value.pais +'</option>');
   			}
   	});
   }
   ...
   function getCities(countrie){
   	var x=1;
   	$.each(incotermsDb, function (key, value){
   		if((value.pais === countrie) && ($.inArray(value.ciudad, cities) === -1)){ 
   			...
   			$('#ciudad_origen').append('<option value="'+ value.ciudad + '">' + 
   			 																							value.ciudad +'</option>');
   			}
   	});
   }
   	...
   	$.each(incotermsDb, function (key, value){
   		...
   		if ((value.pais === countrie) 
   			...
   			if(x === 1){
   				...
   				$('#incoterm').append('<option value="'+ value.incoterms + '">' + 
