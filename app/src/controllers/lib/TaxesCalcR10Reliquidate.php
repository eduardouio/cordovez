...
class orderTaxesReliquidate {
    ...
    private function getDetailTaxesProduct(
        ...
        {
            $order = $this->init_data['order'];   

            $fodinfa = ($order['fodinfa_pagado']);
            ...
            $arancel_advalorem = floatval($order['arancel_advalorem_pagado']);
            $arancel_especifico = floatval($order['arancel_especifico_pagado']);
            
            $ice_advalorem_pagado = $order['ice_advalorem_pagado'];
